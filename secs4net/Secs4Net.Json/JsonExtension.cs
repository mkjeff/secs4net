...
namespace Secs4Net.Json
{
    public static class JsonExtension
    {
        ...
        public static void WriteTo(this SecsMessage msg, JsonWriter jwtr)
        {
        ...
        public static async Task WriteToAsync(this SecsMessage msg, JsonWriter jwtr)
        {
        ...
        public static void WriteTo(this Item item, JsonWriter writer)
        {
            ...
            void WriteValue<T>(JsonWriter w, Item i) where T : struct
            {
                w.WriteStartArray();
        ...
        public static async Task WriteToAsync(this Item item, JsonWriter writer)
        {
            ...
            async Task WriteListAsync(JsonWriter w, Item i)
            {
            ...
            Task WriteItemValueAsync(JsonWriter w, Item i)
            {
                switch (i.Format)
                {
                    case SecsFormat.ASCII:
		...
		public static SecsMessage ToSecsMessage(this JsonReader reader) => JObject.Load(reader).ToSecsMessage();
