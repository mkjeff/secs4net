...
namespace Secs4Net
{
    partial class Item
    {
        ...
        public static Item B(params byte[] value) => value.Length > 0 ? new ValueArrayItem<byte>(SecsFormat.Binary, value) : B();
        ...
        public static Item U1(params byte[] value) => value.Length > 0 ? new ValueArrayItem<byte>(SecsFormat.U1, value) : U1();
        ...
        public static Item U2(params ushort[] value) => value.Length > 0 ? new ValueArrayItem<ushort>(SecsFormat.U2, value) : U2();
        ...
        public static Item U4(params uint[] value) => value.Length > 0 ? new ValueArrayItem<uint>(SecsFormat.U4, value) : U4();
        ...
        public static Item U8(params ulong[] value) => value.Length > 0 ? new ValueArrayItem<ulong>(SecsFormat.U8, value) : U8();
        ...
        public static Item I1(params sbyte[] value) => value.Length > 0 ? new ValueArrayItem<sbyte>(SecsFormat.I1, value) : I1();
        ...
        public static Item I2(params short[] value) => value.Length > 0 ? new ValueArrayItem<short>(SecsFormat.I2, value) : I2();
        ...
        public static Item I4(params int[] value) => value.Length > 0 ? new ValueArrayItem<int>(SecsFormat.I4, value) : I4();
        ...
        public static Item I8(params long[] value) => value.Length > 0 ? new ValueArrayItem<long>(SecsFormat.I8, value) : I8();
        ...
        public static Item F4(params float[] value) => value.Length > 0 ? new ValueArrayItem<float>(SecsFormat.F4, value) : F4();
        ...
        public static Item F8(params double[] value) => value.Length > 0 ? new ValueArrayItem<double>(SecsFormat.F8, value) : F8();
        ...
        public static Item Boolean(params bool[] value) => value.Length > 0 ? new ValueArrayItem<bool>(SecsFormat.Boolean, value) : Boolean();
