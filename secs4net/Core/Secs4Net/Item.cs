...
namespace Secs4Net
{
    ...
    public abstract partial class Item : IEquatable<Item>, IEnumerable<Item>, IDisposable
    {
        ...
        private static readonly Item EmptyBoolean = new ValueArrayItem<bool>(SecsFormat.Boolean, Array.Empty<bool>());
        private static readonly Item EmptyBinary = new ValueArrayItem<byte>(SecsFormat.Binary, Array.Empty<byte>());
        private static readonly Item EmptyU1 = new ValueArrayItem<byte>(SecsFormat.U1, Array.Empty<byte>());
        private static readonly Item EmptyU2 = new ValueArrayItem<ushort>(SecsFormat.U2, Array.Empty<ushort>());
        private static readonly Item EmptyU4 = new ValueArrayItem<uint>(SecsFormat.U4, Array.Empty<uint>());
        private static readonly Item EmptyU8 = new ValueArrayItem<ulong>(SecsFormat.U8, Array.Empty<ulong>());
        private static readonly Item EmptyI1 = new ValueArrayItem<sbyte>(SecsFormat.I1, Array.Empty<sbyte>());
        private static readonly Item EmptyI2 = new ValueArrayItem<short>(SecsFormat.I2, Array.Empty<short>());
        private static readonly Item EmptyI4 = new ValueArrayItem<int>(SecsFormat.I4, Array.Empty<int>());
        private static readonly Item EmptyI8 = new ValueArrayItem<long>(SecsFormat.I8, Array.Empty<long>());
        private static readonly Item EmptyF4 = new ValueArrayItem<float>(SecsFormat.F4, Array.Empty<float>());
        private static readonly Item EmptyF8 = new ValueArrayItem<double>(SecsFormat.F8, Array.Empty<double>());
