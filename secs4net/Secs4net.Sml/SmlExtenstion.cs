    ...
    public static class SmlExtension
    {
        ...
        public static async Task WriteAsync(TextWriter writer, SecsItem item, int indent = 4)
        {
            ...
            Task WriteItemAcyn()
            {
                ...
                async Task WriteListAsnc(TextWriter w, SecsItem secsItem, int d, string dStr)
                {
        ...
        private static bool ParseItem(string line, Stack<List<SecsItem>> stack, ref SecsItem rootSecsItem)
        {
            line = line.TrimStart();
        ...
        private static readonly (Func<SecsItem>, Func<int[], SecsItem>, Func<string, int>) 
            I4Parser = (I4, I4, int.Parse);
        private static readonly (Func<SecsItem>, Func<long[], SecsItem>, Func<string, long>) 
            I8Parser = (I8, I8, long.Parse);
        private static readonly (Func<SecsItem>, Func<byte[], SecsItem>, Func<string, byte>) 
            U1Parser = (U1, U1, byte.Parse);
        private static readonly (Func<SecsItem>, Func<ushort[], SecsItem>, Func<string, ushort>) 
            U2Parser = (U2, U2, ushort.Parse);
        private static readonly (Func<SecsItem>, Func<uint[], SecsItem>, Func<string, uint>) 
            U4Parser = (U4, U4, uint.Parse);
        private static readonly (Func<SecsItem>, Func<ulong[], SecsItem>, Func<string, ulong>) 
            U8Parser = (U8, U8, ulong.Parse);
        private static readonly (Func<SecsItem>, Func<float[], SecsItem>, Func<string, float>) 
            F4Parser = (F4, F4, float.Parse);
        private static readonly (Func<SecsItem>, Func<double[], SecsItem>, Func<string, double>) 
            F8Parser = (F8, F8, double.Parse);
        private static readonly (Func<SecsItem>, Func<bool[], SecsItem>, Func<string, bool>) 
            BoolParser = (Boolean, Boolean, bool.Parse);
        private static readonly (Func<SecsItem>, Func<string, SecsItem>) 
            AParser = (A, A);
        private static readonly (Func<SecsItem>, Func<string, SecsItem>) 
            JParser = (J, J);
        ...
        public static SecsItem Create(this string format, string smlValue)
        {
            ...
            SecsItem ParseValueItem<T>(string str,  (Func<SecsItem> emptyCreator, Func<T[], SecsItem> creator, Func<string, T> converter) parser)
            {
            ...
            SecsItem ParseStringItem(string str, (Func<SecsItem> emptyCreator, Func<string, SecsItem> creator) parser)
            {
