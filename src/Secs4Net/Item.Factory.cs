...
partial class Item
{
    ...
    public static Item B(Memory<byte> value) => new MemoryItem<byte>(SecsFormat.Binary, value);
    public static Item B(IMemoryOwner<byte> valueOwner) => new MemoryOwnerItem<byte>(SecsFormat.Binary, valueOwner);

    public static Item U1(params byte[] value) => U1(value.AsMemory());
    public static Item U1(IEnumerable<byte> value) => U1(value.ToArray());
    public static Item U1(Memory<byte> value) => new MemoryItem<byte>(SecsFormat.U1, value);
    public static Item U1(IMemoryOwner<byte> valueOwner) => new MemoryOwnerItem<byte>(SecsFormat.U1, valueOwner);
    ...
    public static Item U2(Memory<ushort> value) => new MemoryItem<ushort>(SecsFormat.U2, value);
    public static Item U2(IMemoryOwner<ushort> valueOwner) => new MemoryOwnerItem<ushort>(SecsFormat.U2, valueOwner);

    public static Item U4(params uint[] value) => U4(value.AsMemory());
    public static Item U4(IEnumerable<uint> value) => U4(value.ToArray());
    public static Item U4(Memory<uint> value) => new MemoryItem<uint>(SecsFormat.U4, value);
    public static Item U4(IMemoryOwner<uint> valueOwner) => new MemoryOwnerItem<uint>(SecsFormat.U4, valueOwner);

    public static Item U8(params ulong[] value) => U8(value.AsMemory());
    public static Item U8(IEnumerable<ulong> value) => U8(value.ToArray());
    public static Item U8(Memory<ulong> value) => new MemoryItem<ulong>(SecsFormat.U8, value);
    public static Item U8(IMemoryOwner<ulong> valueOwner) => new MemoryOwnerItem<ulong>(SecsFormat.U8, valueOwner);

    public static Item I1(params sbyte[] value) => I1(value.AsMemory());
    public static Item I1(IEnumerable<sbyte> value) => I1(value.ToArray());
    public static Item I1(Memory<sbyte> value) => new MemoryItem<sbyte>(SecsFormat.I1, value);
    public static Item I1(IMemoryOwner<sbyte> valueOwner) => new MemoryOwnerItem<sbyte>(SecsFormat.I1, valueOwner);

    public static Item I2(params short[] value) => I2(value.AsMemory());
    public static Item I2(IEnumerable<short> value) => I2(value.ToArray());
    public static Item I2(Memory<short> value) => new MemoryItem<short>(SecsFormat.I2, value);
    public static Item I2(IMemoryOwner<short> valueOwner) => new MemoryOwnerItem<short>(SecsFormat.I2, valueOwner);

    public static Item I4(params int[] value) => I4(value.AsMemory());
    public static Item I4(IEnumerable<int> value) => I4(value.ToArray());
    public static Item I4(Memory<int> value) => new MemoryItem<int>(SecsFormat.I4, value);
    public static Item I4(IMemoryOwner<int> valueOwner) => new MemoryOwnerItem<int>(SecsFormat.I4, valueOwner);

    public static Item I8(params long[] value) => I8(value.AsMemory());
    public static Item I8(IEnumerable<long> value) => I8(value.ToArray());
    public static Item I8(Memory<long> value) => new MemoryItem<long>(SecsFormat.I8, value);
    public static Item I8(IMemoryOwner<long> valueOwner) => new MemoryOwnerItem<long>(SecsFormat.I8, valueOwner);

    public static Item F4(params float[] value) => F4(value.AsMemory());
    public static Item F4(IEnumerable<float> value) => F4(value.ToArray());
    public static Item F4(Memory<float> value) => new MemoryItem<float>(SecsFormat.F4, value);
    public static Item F4(IMemoryOwner<float> valueOwner) => new MemoryOwnerItem<float>(SecsFormat.F4, valueOwner);
    ...
    public static Item F8(Memory<double> value) => new MemoryItem<double>(SecsFormat.F8, value);
    public static Item F8(IMemoryOwner<double> valueOwner) => new MemoryOwnerItem<double>(SecsFormat.F8, valueOwner);
    ...
    public static Item Boolean(Memory<bool> value) => new MemoryItem<bool>(SecsFormat.Boolean, value);
    public static Item Boolean(IMemoryOwner<bool> valueOwner) => new MemoryOwnerItem<bool>(SecsFormat.Boolean, valueOwner);
